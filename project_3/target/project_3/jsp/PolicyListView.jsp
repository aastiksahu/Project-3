	...
	<div>
		<form class="pb-5" action="<%=ORSView.POLICY_LIST_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="premiumAmount" placeholder="Enter Premium Amount"
						class="form-control"
				...
				<div class="col-sm-2">
					<input type="submit" class="btn btn-primary btn-md"
						...
						value="<%=PolicyListCtl.OP_SEARCH%>">&emsp; <input
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th width="15%" class="text">Policy Name</th>
							<th width="15%" class="text">Premium Amount</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><a href="PolicyCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
					</tbody>
					<%
						}
			...
			<table width="100%">
				<tr>
					...
					<td><input type="submit" name="operation"
						...
						value="<%=PolicyListCtl.OP_NEW%>"></td>
					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md" style="font-size: 17px"
						value="<%=PolicyListCtl.OP_DELETE%>"></td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md" style="font-size: 17px"
						style="padding: 5px;" value="<%=PolicyListCtl.OP_NEXT%>"
			...
			%>
			<center>
				<h1 style="font-size: 40px; color: #162390;">Policy List</h1>
			</center>
			</br>
			<div class="row">
				<div class="col-md-4"></div>
			...
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					style="font-size: 17px" value="<%=PolicyListCtl.OP_BACK%>">
			</div>
