...
public class PolicyModelHibImpl implements PolicyModelInt{
	...
	public long add(PolicyDTO dto) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			throw new ApplicationException("Exception in Add Policy Details " + e.getMessage());
		} finally {
			session.close();
		}
		return dto.getId();
	...
	public void delete(PolicyDTO dto) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException("Exception in Delete Policy Details" + e.getMessage());
		} finally {
			session.close();
		}
	...
	public void update(PolicyDTO dto) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			throw new ApplicationException("Exception in update Policy Details" + e.getMessage());
		} finally {
			session.close();
		}
	...
	public PolicyDTO findByPK(long pk) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException("Exception : Exception in getting Policy Details by pk");
		} finally {
			session.close();
		}
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException("Exception : Exception in  Policy Details");
		} finally {
			session.close();
		}
	...
	public List search(PolicyDTO dto, int pageNo, int pageSize) throws ApplicationException {
		...
		try {
			...
			if (dto != null) {
				...
				if (dto.getPremiumAmount() > 0) {
					criteria.add(Restrictions.like("premiumAmount", dto.getPremiumAmount()));
				}
			...
			throw new ApplicationException("Exception in Policy Details search");
		} finally {
			session.close();
		}
