...
public class StaffMemberListCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("StaffMemberListCtl doGet Start");
		...
		try {
			...
			System.out.println("next list size is " + next.size());
...
//					System.out.println("BEFORE++" + pageNo);
//					pageNo++;
//					System.out.println("AFTER++" + pageNo);
