					...
					<div class="card input-group-addon">
						<div class="card-body">
							...
							<%
								...
								if (dto.getSettingName() != null && dto.getId() > 0) {
							%>
							...
							<div class="md-form">
								...
								<span class="pl-sm-5"><b>Settings Name</b> <span
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										...
										value="<%=SettingsCtl.OP_UPDATE%>"> <input
										type="submit" name="operation" class="btn btn-warning btn-md"
										style="font-size: 17px" value="<%=SettingsCtl.OP_CANCEL%>">
								...
								<div class="text-center">
									...
									<input type="submit" name="operation"
										class="btn btn-success btn-md" style="font-size: 17px"
										value="<%=SettingsCtl.OP_SAVE%>"> <input type="submit"
										name="operation" class="btn btn-warning btn-md"
										style="font-size: 17px" value="<%=SettingsCtl.OP_RESET%>">
								</div>
								<%
									}
								%>
