...
<body class="hm">
	<div>
		<form class="pb-5" action="<%=ORSView.STAFF_MEMBER_LIST_CTL%>"
			method="post">
			...
			<%
				...
				System.out.println("in view " + nextPageSize);
				List list = ServletUtility.getList(request);
				System.out.println("list in view " + list.size());
			...
			<div class="row">
				...
				<div class="col-sm-2"></div>
				<div class="col-sm-2">
					<input type="text" id="datepicker" name="joiningDate" placeholder="Enter Joining Date"
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th width="15%" class="text">Joining Date</th>
							<th width="20%" class="text">Division</th>
							<th width="10%" class="text">Previous Employer</th>
					...
					<tbody>
						<tr>
							...
							<td class="text"><%=dto.getJoiningDate()%></td>
			...
			%>
			<center>
				<h1 style="font-size: 40px; color: #162390;">Staff Member List</h1>
			</center>
			</br>
			<div class="row">
				<div class="col-md-4"></div>
